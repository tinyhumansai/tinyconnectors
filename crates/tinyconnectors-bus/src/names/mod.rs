...
pub const INTERFACE: &str = "ai.tinyhumans.connectors.Greeting";

/// The object path the module serves its interface at.
pub const OBJECT_PATH: &str = "/ai/tinyhumans/connectors/Greeting";
...
///
/// `crates/tinyconnectors` asserts its declared manifest methods against this list,
